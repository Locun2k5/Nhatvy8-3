...
<body>
    ...
    <script>
        ...
        const textLetterH2 = "Gửi Nhật Vy!";
        ...
        const textLetterP = "Nhân ngày 8/3, chúc Cậu luôn xinh đẹp, mạnh khỏe, hạnh phúc, tiền trong ví dày hơn và đạt được mọi điều may mắn trong cuộc sống. Mong sau này tớ với cậu sẽ có cơ hội gặp nhau ở bên ngoài!";
